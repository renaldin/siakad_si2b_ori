      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <?php if (Auth::user()->level == 1) { ?>
            <span class="text-white">Level: Admin</span>
          <?php } else if(Auth::user()->level == 2) {?>
            <span class="text-white">Level: User</span>
          <?php } else if(Auth::user()->level == 3) {?>
            <span class="text-white">Level: Mahasiswa</span>
          <?php } else if(Auth::user()->level == 4) {?>
            <span class="text-white">Level: Dosen</span>
          <?php }?>
        </div>
      </div>
